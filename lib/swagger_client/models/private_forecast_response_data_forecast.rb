...
module SwaggerClient
  class PrivateForecastResponseDataForecast
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'time_start')
        self.time_start = attributes[:'time_start']
      end

      if attributes.has_key?(:'time_end')
      ...
      if attributes.has_key?(:'weighted_price')
        self.weighted_price = attributes[:'weighted_price']
      end
    ...
    def list_invalid_properties
      ...
      if @weighted_price.nil?
        invalid_properties.push('invalid value for "weighted_price", weighted_price cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @weighted_price.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          time_end == o.time_end &&
          low == o.low &&
          weighted_price == o.weighted_price &&
          high == o.high &&
    ...
    def hash
      [time_start, time_end, low, weighted_price, high, confidence, change_usd, change_pct].hash
    end
