...
describe 'PrivateApi' do
  ...
  # unit tests for v1_private_forecast_accuracy_symbol_interval_period_get
  # Forecast Accuracy
  # 
  # @param symbol The cryptocurrency symbol.
  # @param interval The forecast interval, 1h or 1d.
  ...
  describe 'v1_private_forecast_accuracy_symbol_interval_period_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for v1_private_forecast_time_symbol_interval_period_get
  # Forecast Time
  # 
  # @param symbol The cryptocurrency symbol.
  # @param interval The forecast interval, 1h or 1d.
  ...
  describe 'v1_private_forecast_time_symbol_interval_period_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
